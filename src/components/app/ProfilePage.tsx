...
import type { UserTransaction, Video, AppUser } from '@/lib/types';
...
export function ProfilePage() {
  ...
  // Single shared Firebase listener.
  useUserData();
  ...
  // Sync local state from the store (single source of truth).
  useEffect(() => {
    if (user) {
  ...
  return (
    <div className="px-4 pt-2 pb-4 space-y-5">
      ...
      <div className="text-center pb-4">
        <p className="text-[11px] text-muted-foreground/40">v2.0.0</p>
      </div>
